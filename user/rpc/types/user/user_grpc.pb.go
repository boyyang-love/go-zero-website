...
func (c *userClient) DelUser(ctx context.Context, in *DelUserReq, opts ...grpc.CallOption) (*DelUserRes, error) {
	out := new(DelUserRes)
...
func (UnimplementedUserServer) DelUser(context.Context, *DelUserReq) (*DelUserRes, error) {
