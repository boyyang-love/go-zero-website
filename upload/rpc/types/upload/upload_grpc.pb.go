...
func (c *uploadClient) UploadFile(ctx context.Context, in *UploadFileReq, opts ...grpc.CallOption) (*UploadFileRes, error) {
...
func (UnimplementedUploadServer) UploadFile(context.Context, *UploadFileReq) (*UploadFileRes, error) {
